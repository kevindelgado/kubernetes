...
// StopHandle gives the caller of a shared informer information
...
func (v *dummyController) RunWithStopOptions(ctx context.Context, cancel context.CancelFunc, stopOptions StopOptions) {
}
...
func (s *sharedIndexInformer) RunWithStopOptions(ctx context.Context, stopOptions StopOptions) {
	...
	defer ctrlCancel()
	s.stopHandleMu.Lock()
	s.stopHandle = ctrlCtx
	s.stopHandleMu.Unlock()
