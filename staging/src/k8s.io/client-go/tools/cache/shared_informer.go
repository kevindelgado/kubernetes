...
// anytime time the underlying reflector's ListAndWatch call returns an error
...
type StopOptions struct {
	// StopOnError inspects errors returned from the underlying reflector's List call,
