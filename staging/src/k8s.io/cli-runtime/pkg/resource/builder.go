...
// kdelga: this is the builder, generated by the factory used in RunCreate()
// kdelga: A builder takes arguments and params from the command line and coverts them to a list of
// resources to iterate over using this Visit interface...
// kdelga: (optional)when Visit is called on the resource it has info containing all the data it needs to make a REST call
// (such as the resource to be created serialized as a kubernetes Object)
type Builder struct {
...
// kdelga: finish the builder with do, return the Result that we call visit on.
