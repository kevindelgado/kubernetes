...
// kdelga: here's the api installer
...
// kdelga: here's the install,
// it runs through all the groups and calls swagger & open api setup code to give autogenerated docs
// as it builds the paths
// lastly it calls registerResourceHandelrs
...
// kdelga: this is a doozy
// set up long list of handler paths that get programmed into go-restful
func (a *APIInstaller) registerResourceHandlers(path string, storage rest.Storage, ws *restful.WebService) (*metav1.APIResource, error) {
	...
	for _, action := range actions {
		...
		case "POST": // Create a resource.
			// kdelga: this is how we program the create handler for go restful
			var handler restful.RouteFunction
			if isNamedCreater {
...
//kdelga:  This is where we actually handle the requests!
// (well actually, one layer deeper in CreateResource)
